  ...
  AuthProvider authProvider = Provider.of<AuthProvider>(context);
    ...
    return ListView(
      ...
      children: [
        ...
        Column(
          children: cartProvider.carts.map((cart) => CheckoutCard(cart: cart)).toList(),
        ),
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('\$${cartProvider.totalPrice()}', style: priceTextStyle.copyWith(
                    fontWeight: semiBold,
                  ),),
                ],
              ),
